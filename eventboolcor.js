(function (global, factory) {
  ...
  var getDeviceInfo = function getDeviceInfo() {
    ...
    var getBrowserVersion = function getBrowserVersion() {
      ...
      var versionRegEx = (_IEMobile$Edge$Chrome = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_IEMobile$Edge$Chrome, IEMobile, /rv:(\d+(\.\d+)?)/), Edge, /Edge\/(\d+(\.\d+)?)/), Chrome, /Chrome\/(\d+(\.\d+)?)/), ChromeIOS, /CriOS\/(\d+(\.\d+)?)/), UC, /(UCBrowser|UCWEB)\/(\d+(\.\d+)?)/), Safari, /Version\/(\d+(\.\d+)?)/), SafariMobile, /Version\/(\d+(\.\d+)?)/), Opera, /(Opera|OPR)\/(\d+(\.\d+)?)/), Firefox, /Firefox\/(\d+(\.\d+)?)/), FirefoxIOS, /FxiOS\/(\d+(\.\d+)?)/), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_IEMobile$Edge$Chrome, Konqueror, /Konqueror:(\d+(\.\d+)?)/), BlackBerry, /BlackBerry (\d+(\.\d+)?)/), AndroidMobile, /android\s(\d+(\.\d+)?)/), IE, /(rv:|MSIE )(\d+(\.\d+)?)/), Mozilla, /rv:(\d+(\.\d+)?)/))[browser];
  ...
  var getDefaultUserProperties = function getDefaultUserProperties() {
    ...
    return _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, APX_PREFIX + "browser", browser), APX_PREFIX + "browser_version", browser + "_" + browser_version), APX_PREFIX + "language", language), APX_PREFIX + "cookies_supported", cookie_supported);
  };
  ...
  var CHUNKS_API = "/<app-id>/chunks?isTestDevice=<test-device>";
  ...
  var ApxorSDK = /*#__PURE__*/function () {
    function ApxorSDK(window) {
      ...
      _defineProperty(this, "version", 240);
